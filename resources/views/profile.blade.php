        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">Ikhsan Sirojudin</div>
                    <div class="col-md-6">: {{ $nama }}</div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">Bandung, 11 Mei 2004</div>
                  ...
                  <div class="row">
                    <div class="col-md-6">Islam</div>
                    <div class="col-md-6">: {{ $agama }}</div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">Jl. Jati Pasirbiru</div>
                    <div class="col-md-6">: {{ $alamat }}</div>
                 </div>
                  <div class="row">
                     <div class="col-md-6">088223670046</div>
                     <div class="col-md-6">: {{ $telp }}</div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">Ikhsansirojudin5@gmail.com</div>
          ...
          <div class="col-md-4">
            ...
            <div class="list-group">
                ...
                <div class="list-group-item list-group-item-action">
                  <h5 class="mb-1">Mts Ar-Rosyidiyah</h5>
                  <small>2016 - 2019</small>
                </div>
                <div class="list-group-item list-group-item-action">
                  <h5 class="mb-1">SD Negeri 03 Bandung </h5>
